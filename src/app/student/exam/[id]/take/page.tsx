...
export default function TakeExamPage() {
  ...
  // (state updates are async) so the debounced local save and the periodic
  // server sync always read the true latest values, never a stale closure.
  ...
  async function loadData() {
    ...
    // the next sync tick) — merge those in, local taking precedence. This is
    // what makes "resume after restart" actually resume the true latest
    // state, not just whatever last successfully synced.
